...
def get_args():
    ...
    parser.add_argument('-g_type', choices = ['dcgan','rnn_dcnn','gridrnn_dcnn','hidden1','hidden2','hidden3','hidden4'], default='hidden4', help='Choose G')
    parser.add_argument('-d_type', choices = ['dcgan','hidden1','hidden2','hidden3','hidden4'], default='hidden4', help='Choose D')
    parser.add_argument('-dec_type', choices = ['dcgan','rnn_dcnn','gridrnn_dcnn','hidden1','hidden2','hidden3','hidden4'], default='hidden4', help='Choose Dec')
    ...
    parser.add_argument('-gan_type', choices = ['dcgan', 'wgan', 'wgan_gp', 'hidden'], default='hidden', help='gan structures.')
